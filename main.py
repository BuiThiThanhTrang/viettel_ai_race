...
def main():
    ...
    parser.add_argument("--input_dir", type=str, default=r".\\input", help="Thư mục chứa các file text đầu vào")
    parser.add_argument("--output_dir", type=str, default=r".\\output", help="Thư mục chứa các file JSON đầu ra")
